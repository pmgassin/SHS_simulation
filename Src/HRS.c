...
Dep=cv/av;
betaHRS=sqrt((av)+(ch));
betaHRS_esu=betaHRS*8.639*pow(10,-3);

printf("I2v = %lf \n",I2v);
printf("I4v = %lf \n",I4v);
printf("I2h = %lf \n",I2h);
printf("I4h = %lf \n",I4h);
printf("DEPOLARIZATION = %lf \n",Dep);
printf("beta_HRS = %lf au\n",betaHRS);
printf("beta_HRS = %lf *10^(-30)esu\n",betaHRS_esu);
//printf("av = %lf  au^2 \n",av);
//printf("cv = %lf  au^2 \n",cv);
