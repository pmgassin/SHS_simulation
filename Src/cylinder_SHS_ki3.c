...
double hx,hy,xi,yj,hx2,hy2,xi2,yj2,phii,thetai,psii,hd;
double compteur;
...
int pas2,pas3,pasvariable,dee,mmm,mmmf;
...
double R,R0,length,lengthdebye;
pisur2=pi/2;
pas2=10;
pas=10;
...
for (dee=0;dee<1;dee++){
	...
	for (i=0;i<nx;i++){
		for (j=0;j<ny;j++){
			...
			grandgammazxx_moy=grandgammazxx_moy+hd*hx*hy*gzxx(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
       		grandgammaxxx_moy=grandgammaxxx_moy+hd*hx*hy*gxxx(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
        	grandgammayxx_moy=grandgammayxx_moy+hd*hx*hy*gyxx(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
       		grandgammaxyy_moy=grandgammaxyy_moy+hd*hx*hy*gxyy(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
        	grandgammazyy_moy=grandgammazyy_moy+hd*hx*hy*gzyy(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
       		grandgammayyy_moy=grandgammayyy_moy+hd*hx*hy*gyyy(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
       		grandgammaxxy_moy=grandgammaxxy_moy+hd*hx*hy*gxxy(R,xi,yj,phii,thetai,psii,beta,petitk,grandk,grandtheta);
